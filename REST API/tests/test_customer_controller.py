...
def test_get_customer(client):
    response = client.get("/customers/PANUKI")
    assert response.status_code == 200
    assert "application/json" in response.content_type
