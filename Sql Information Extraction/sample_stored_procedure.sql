CREATE
OR REPLACE PROCEDURE ManageEmployeeAndDepartment(
    EmployeeID INT,
...
) RETURNS STRING LANGUAGE JAVASCRIPT EXECUTE AS CALLER AS $ $ var result = "";

/ / CREATE tables if not exist var createEmployeeTable = `CREATE TABLE IF NOT EXISTS Employee (
...
INSERT
    ...
    JOIN (
        ...
        NewEmployeeID != = null & & NewDepartmentID != = null
...
UPDATE
    ...
    JOIN (
        Update
            Employee 's salary based on department)
